  ...
  <div id="main-container">
    ...
    <main>
      <div class="left">
        ...
        <div id="games">
          <img :src="require('@/assets/cyberpunk.png')" alt="cyberpunk" />
          <img :src="require('@/assets/modrinth.png')" alt="modrinth" />
          <img
            :src="require('@/assets/Genshin_Impact.webp')"
            alt="genshin impact"
          />
          <img :src="require('@/assets/va11halla.jpg')" alt="va11halla" />
          <img :src="require('@/assets/pjsk.webp')" alt="project sekai" />
          <img :src="require('@/assets/osu.png')" alt="osu" />
        </div>
      </div>
